...
\begin{figure}[!tbh]
\centering      
   \subfloat [Ground Truth] {\includegraphics[width=0.484\textwidth]{../viz/tooth_ground_truth.png}}
   \subfloat [L Shepard's 2] {\includegraphics[width=0.49\textwidth]{../viz/1M_K10_R01_tooth_S2_L_-z.png}}
	\caption{Tooth model with 1M scatter data point, $K=10$}
   \label{fig:r2}
\end{figure}
...
\begin{figure}[!tbh]
\centering      
   \subfloat [Ground Truth] {\includegraphics[width=0.49\textwidth]{../viz/stent_ground_truth.png}}
   \subfloat [L Shepard's 2] {\includegraphics[width=0.49\textwidth]{../viz/1M_K10_R01_stent_S2_L_+y.png}}
	\caption{Stent model with 1M scatter data point, $K=10$}
   \label{fig:r2}
\end{figure}
